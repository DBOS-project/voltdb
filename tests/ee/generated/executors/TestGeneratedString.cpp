...
class TestGeneratedString : public PlanTestingBaseClass<EngineTestTopend> {
public:
    /*
     ...
     */
    TestGeneratedString(uint32_t randomSeed = (unsigned int)time(NULL)) {
 ...
 */
TEST_F(TestGeneratedString, test_long_string) {
    static int testIndex = 0;
    executeTest(allTests[testIndex]);
}
TEST_F(TestGeneratedString, test_short_string) {
...
const char *CCCSHORTANS_ColumnNames[] = {
    "ID",
    "NAME",
    "DATA",
};
const char *CCCLONGANS_ColumnNames[] = {
    "ID",
    "NAME",
    "DATA",
};
...
const voltdb::ValueType CCCSHORTANS_Types[] = {
    voltdb::ValueType::tINTEGER,
    voltdb::ValueType::tVARCHAR,
    voltdb::ValueType::tVARCHAR,
};
const voltdb::ValueType CCCLONGANS_Types[] = {
    voltdb::ValueType::tINTEGER,
    voltdb::ValueType::tVARCHAR,
    voltdb::ValueType::tVARCHAR,
};
...
const int32_t CCCSHORTANS_Sizes[] = {
    4,
    32,
    1024,
};
const int32_t CCCLONGANS_Sizes[] = {
    4,
    32,
    1024,
};
 ...
 */
int32_t num_CCC_strings = 2;
const char *CCC_Strings[] = {
    "alpha",
    "beta",
};
int32_t num_CCCSHORTANS_strings = 2;
const char *CCCSHORTANS_Strings[] = {
    "al",
    "be",
};
int32_t num_CCCLONGANS_strings = 2;
const char *CCCLONGANS_Strings[] = {
    "alphaalpha",
    "betabeta",
};
 ...
 */
const int NUM_TABLE_ROWS_CCC = 1;
const int NUM_TABLE_COLS_CCC = 3;
const int CCCData[NUM_TABLE_ROWS_CCC * NUM_TABLE_COLS_CCC] = {
    100,  0,  1,
};

const int NUM_TABLE_ROWS_CCCSHORTANS = 1;
const int NUM_TABLE_COLS_CCCSHORTANS = 3;
const int CCCSHORTANSData[NUM_TABLE_ROWS_CCCSHORTANS * NUM_TABLE_COLS_CCCSHORTANS] = {
    100,  0,  1,
};

const int NUM_TABLE_ROWS_CCCLONGANS = 1;
const int NUM_TABLE_COLS_CCCLONGANS = 3;
const int CCCLONGANSData[NUM_TABLE_ROWS_CCCLONGANS * NUM_TABLE_COLS_CCCLONGANS] = {
    100,  0,  1,
};
...
const TableConfig CCCSHORTANSConfig = {
    "CCCSHORTANS",
    CCCSHORTANS_ColumnNames,
    CCCSHORTANS_Types,
    CCCSHORTANS_Sizes,
    NUM_TABLE_ROWS_CCCSHORTANS,
    NUM_TABLE_COLS_CCCSHORTANS,
    CCCSHORTANSData,
    CCCSHORTANS_Strings,
    num_CCCSHORTANS_strings
};
const TableConfig CCCLONGANSConfig = {
    "CCCLONGANS",
    CCCLONGANS_ColumnNames,
    CCCLONGANS_Types,
    CCCLONGANS_Sizes,
    NUM_TABLE_ROWS_CCCLONGANS,
    NUM_TABLE_COLS_CCCLONGANS,
    CCCLONGANSData,
    CCCLONGANS_Strings,
    num_CCCLONGANS_strings
};
...
DBConfig TestGeneratedString::m_testDB =

{
    ...
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-10 sqltext \"select A, B, max(-1 * abs(3-C)) over (partition by A order by B) as R from T ORDER BY A, B, R;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
    ...
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-11 sqltext \"select A, B, max(-1 * abs(5-C)) over (partition by A order by B) as R from T ORDER BY A, B, R;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
    ...
    "set $PREV cachekeyprefix \"\"\n"
    "set $PREV functionDependees \"\"\n"
    "add /clusters#cluster/databases#database/procedures#testplansgenerator statements stmt-12\n"
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-12 sqltext \"select A, B, sum(B+C) over (partition by A order by B) as R from T ORDER BY A, B, R;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
    ...
    "set $PREV cachekeyprefix \"\"\n"
    "set $PREV functionDependees \"\"\n"
    "add /clusters#cluster/databases#database/procedures#testplansgenerator statements stmt-13\n"
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-13 sqltext \"select A, B, C, rank() over (partition by A order by B) as R from T ORDER BY A, B, C, R;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
    ...
    "set $PREV cachekeyprefix \"\"\n"
    "set $PREV functionDependees \"\"\n"
    "add /clusters#cluster/databases#database/procedures#testplansgenerator statements stmt-14\n"
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-14 sqltext \"select A, B, C, dense_rank() over (partition by A order by B) as R from T ORDER BY A, B, C, R;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
    ...
    "set $PREV cachekeyprefix \"\"\n"
    "set $PREV functionDependees \"\"\n"
    "add /clusters#cluster/databases#database/procedures#testplansgenerator statements stmt-15\n"
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-15 sqltext \"select A, B, C, row_number() over (partition by A order by B) as R from T ORDER BY A;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
    ...
    "set $PREV cachekeyprefix \"\"\n"
    "set $PREV functionDependees \"\"\n"
    "add /clusters#cluster/databases#database/procedures#testplansgenerator statements stmt-16\n"
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-16 sqltext \"select A, B, C, row_number() over (partition by A) as R from T ORDER BY A;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
    ...
    "set $PREV cachekeyprefix \"\"\n"
    "set $PREV functionDependees \"\"\n"
    "add /clusters#cluster/databases#database/procedures#testplansgenerator statements stmt-17\n"
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-17 sqltext \"select A, B, C, row_number() over () as R from T;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
    ...
    "set /clusters#cluster/databases#database/procedures#testplansgenerator/statements#stmt-9 sqltext \"select A, B, max(-1 * abs(1-C)) over (partition by A order by B) as R from T ORDER BY A, B, R;\"\n"
    "set $PREV querytype 2\n"
    "set $PREV readonly true\n"
    "set $PREV singlepartition true\n"
    "set $PREV replicatedtabledml false\n"
