...
class TestInsertPolygons : public PlanTestingBaseClass<EngineTestTopend> {
public:
    /*
     ...
     */
    TestInsertPolygons(uint32_t randomSeed = (unsigned int)time(NULL)) {
 ...
 */
TEST_F(TestInsertPolygons, test_insert_polygons) {
...
TestConfig allTests[1] = {
    {
        // SQL Statement
        "insert into polygons values (100, validpolygonfromtext('POLYGON ((-102.052 41.002, -109.045 41.002, -109.045 36.999, -102.052 36.999, -102.052 41.002), (-104.035 40.24, -104.035 39.188, -105.714 39.188, -105.714 40.24, -104.035 40.24))'));",
        // Failure is expected
        false,
        // Plan String
        "{\n"
        ...
        "                                \"ISNULL\": false,\n"
        "                                \"TYPE\": 30,\n"
        "                                \"VALUE\": \"POLYGON ((-102.052 41.002, -109.045 41.002, -109.045 36.999, -102.052 36.999, -102.052 41.002), (-104.035 40.24, -104.035 39.188, -105.714 39.188, -105.714 40.24, -104.035 40.24))\",\n"
        "                                \"VALUE_SIZE\": 1048576,\n"
        "                                \"VALUE_TYPE\": 9\n"
        "                            }],\n"
        "                            \"FUNCTION_ID\": 21020,\n"
        "                            \"NAME\": \"validpolygonfromtext\",\n"
        "                            \"TYPE\": 100,\n"
        "                            \"VALUE_SIZE\": 1048576,\n"
        "                            \"VALUE_TYPE\": 27\n"
        "                        },\n"
...
DBConfig TestInsertPolygons::m_testDB =
