...
TEST_F(TestWindowedRank, test_row_number) {
    static int testIndex = 2;
    executeTest(allTests[testIndex]);
}
TEST_F(TestWindowedRank, test_row_number_without_order_by) {
    static int testIndex = 3;
    executeTest(allTests[testIndex]);
}
TEST_F(TestWindowedRank, test_row_number_without_partition) {
    static int testIndex = 4;
    executeTest(allTests[testIndex]);
}
...
const char *ROW_NUMBER_OUTPUT_ColumnNames[] = {
    "A",
    "B",
    "C",
    "R",
};
const char *ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_ColumnNames[] = {
    "A",
    "B",
    "C",
    "R",
...
const voltdb::ValueType ROW_NUMBER_OUTPUT_Types[] = {
    voltdb::ValueType::tINTEGER,
    voltdb::ValueType::tINTEGER,
    voltdb::ValueType::tINTEGER,
    voltdb::ValueType::tINTEGER,
};
const voltdb::ValueType ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_Types[] = {
    voltdb::ValueType::tINTEGER,
    voltdb::ValueType::tINTEGER,
    voltdb::ValueType::tINTEGER,
    voltdb::ValueType::tINTEGER,
...
const int32_t ROW_NUMBER_OUTPUT_Sizes[] = {
    4,
    4,
    4,
    4,
};
const int32_t ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_Sizes[] = {
    4,
    4,
    4,
    4,
...
int32_t num_ROW_NUMBER_OUTPUT_strings = 0;
const char *ROW_NUMBER_OUTPUT_Strings[] = {
};
int32_t num_ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_strings = 0;
const char *ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_Strings[] = {
};
...
const int NUM_TABLE_ROWS_ROW_NUMBER_OUTPUT = 15;
const int NUM_TABLE_COLS_ROW_NUMBER_OUTPUT = 4;
const int ROW_NUMBER_OUTPUTData[NUM_TABLE_ROWS_ROW_NUMBER_OUTPUT * NUM_TABLE_COLS_ROW_NUMBER_OUTPUT] = {
      1,  1,101,  1,
      1,  1,102,  2,
      1,  2,201,  3,
      1,  2,202,  4,
...
const int NUM_TABLE_ROWS_ROW_NUMBER_WITHOUT_PARTITION_OUTPUT = 15;
const int NUM_TABLE_COLS_ROW_NUMBER_WITHOUT_PARTITION_OUTPUT = 4;
const int ROW_NUMBER_WITHOUT_PARTITION_OUTPUTData[NUM_TABLE_ROWS_ROW_NUMBER_WITHOUT_PARTITION_OUTPUT * NUM_TABLE_COLS_ROW_NUMBER_WITHOUT_PARTITION_OUTPUT] = {
      1,  1,101,  1,
      1,  1,102,  2,
      1,  2,201,  3,
      1,  2,202,  4,
...
const TableConfig ROW_NUMBER_OUTPUTConfig = {
    "ROW_NUMBER_OUTPUT",
    ROW_NUMBER_OUTPUT_ColumnNames,
    ROW_NUMBER_OUTPUT_Types,
    ROW_NUMBER_OUTPUT_Sizes,
    NUM_TABLE_ROWS_ROW_NUMBER_OUTPUT,
    NUM_TABLE_COLS_ROW_NUMBER_OUTPUT,
    ROW_NUMBER_OUTPUTData,
    ROW_NUMBER_OUTPUT_Strings,
    num_ROW_NUMBER_OUTPUT_strings
};
const TableConfig ROW_NUMBER_WITHOUT_PARTITION_OUTPUTConfig = {
    "ROW_NUMBER_WITHOUT_PARTITION_OUTPUT",
    ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_ColumnNames,
    ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_Types,
    ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_Sizes,
    NUM_TABLE_ROWS_ROW_NUMBER_WITHOUT_PARTITION_OUTPUT,
    NUM_TABLE_COLS_ROW_NUMBER_WITHOUT_PARTITION_OUTPUT,
    ROW_NUMBER_WITHOUT_PARTITION_OUTPUTData,
    ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_Strings,
    num_ROW_NUMBER_WITHOUT_PARTITION_OUTPUT_strings
};
...
const TableConfig *allTables[] = {
    ...
    &ROW_NUMBER_OUTPUTConfig,
    &ROW_NUMBER_WITHOUT_PARTITION_OUTPUTConfig,
};


TestConfig allTests[5] = {
    {
        // SQL Statement
    ...
    {
        // SQL Statement
        "select A, B, C, row_number() over (partition by A order by B) as R from T ORDER BY A;",
        // Failure is expected
        false,
        // Plan String
        "{\n"
        ...
        "                \"AGGREGATE_EXPRESSIONS\": [],\n"
        "                \"AGGREGATE_OUTPUT_COLUMN\": 0,\n"
        "                \"AGGREGATE_TYPE\": \"AGGREGATE_WINDOWED_ROW_NUMBER\"\n"
        "            }],\n"
        "            \"CHILDREN_IDS\": [5],\n"
        "            \"ID\": 4,\n"
        "            \"OUTPUT_SCHEMA\": [\n"
    ...
    {
        // SQL Statement
        "select A, B, C, row_number() over (partition by A) as R from T ORDER BY A;",
        // Failure is expected
        false,
        // Plan String
        "{\n"
    ...
    {
        // SQL Statement
        "select A, B, C, row_number() over () as R from T;",
        // Failure is expected
        false,
        // Plan String
        "{\n"
