...
CREATE PROCEDURE PARTITION ON TABLE votes COLUMN phone_number FROM CLASS voter.VotePart1;
CREATE PROCEDURE PARTITION ON TABLE votes COLUMN phone_number FROM CLASS voter.VotePart2;
