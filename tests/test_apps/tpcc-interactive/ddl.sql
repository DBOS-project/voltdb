...
-- create procedure partition on table warehouse column w_id from class com.procedures.ostatByCustomerIdTemplate;
-- create procedure partition on table warehouse column w_id from class com.procedures.deliveryTemplate;
-- create procedure partition on table warehouse column w_id from class com.procedures.paymentByCustomerNameWTemplate;
-- create procedure partition on table warehouse column w_id from class com.procedures.paymentByCustomerIdWTemplate;
-- create procedure partition on table warehouse column w_id from class com.procedures.neworderTemplate;
-- create procedure partition on table warehouse column w_id from class com.procedures.slevTemplate;
-- create procedure partition on table warehouse column w_id from class com.procedures.ResetWarehouse;
-- create procedure partition on table warehouse column w_id from class com.procedures.ostatByCustomerNameTemplate;
-- create procedure partition on table customer column c_w_id parameter 3 from class com.procedures.paymentByCustomerNameCTemplate;
-- create procedure partition on table customer column c_w_id parameter 3 from class com.procedures.paymentByCustomerIdCTemplate;
...
create procedure partition on table warehouse column w_id from class com.procedures.paymentByCustomerIdWPart1;
create procedure partition on table warehouse column w_id from class com.procedures.paymentByCustomerIdWPart2;
create procedure partition on table warehouse column w_id from class com.procedures.paymentByCustomerIdWPart3;
-- create procedure partition on table warehouse column w_id from class com.procedures.neworderTemplate;
create procedure partition on table warehouse column w_id from class com.procedures.neworderPart1;
