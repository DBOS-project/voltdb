...
public interface SiteProcedureConnection {
        ...
        /**
         * Allows caller to determine that a 50MB temporary (deallocated on next call)
         * buffer
        ...
        /**
         * Let the EE know what the name of the currently executing procedure is so it
         * can include this information in any
        ...
        /**
         * Let the EE know that the currently executing procedure has completed. Should
         * be called by all callers of
        ...
        /**
         * Set the spHandle that's used by snapshot digest as the per-partition txnId.
         * This gets updated during rejoin so
         * that the snapshot right after rejoin can have the correct value. It is also
         ...
         */
        public void truncateUndoLog(boolean rollback, boolean isEmptyDRTxn, long token, long spHandle,
        ...
        public long applyMpBinaryLog(long txnId, long spHandle, long uniqueId, int remoteClusterId,
                        long remoteTxnUniqueId, byte logsData[]);

        public void setDRProtocolVersion(int drVersion);

        /*
         * Starting in DR version 7.0, we also generate a special event indicating the
         * beginning of
         ...
         * This is used by Elastic Shrink after all data from this site has been
         * migrated.
         * The site continues to participate in MP txns until the partition is fully
         * removed from
         * the cluster, but this will disable all external writes as well so that in
         * effect the sites
         * are not participating.
         * <p>
         * By default this is enabled in all sites.
         */
        public void disableExternalStreams();

        /**
         * Returns value showing whether external streams (DR and export) are enabled
         * for this Site.
         *
         ...
         * @param tables    which match in both schemas and can be the target of
         *                  replication
         */
